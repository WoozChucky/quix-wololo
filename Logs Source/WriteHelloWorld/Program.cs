...
internal class Program
{
    ...
    private static async Task Main(string[] args)
    {
        ...
        var clusterCA = Environment.GetEnvironmentVariable("K8SClusterCertificateAuthorityData") ?? throw new InvalidOperationException("K8SClusterCertificateAuthority is not set. Please set it in the environment variables.");
